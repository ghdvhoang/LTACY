(function defineRouter(root) {
  ...
  const NAV = Object.freeze({
    ...
    TEACHER: [['Tổng quan', '/app/teacher/dashboard', 'grid'], ['Buổi học', '/app/teacher/sessions', 'calendar'], ['Nội dung', '/app/teacher/content', 'book'], ['Chấm bài', '/app/teacher/grading', 'check'], ['Khối lượng công việc', '/app/teacher/workload', 'clock'], ['Chất lượng', '/app/teacher/quality', 'trend']],
    TA: [['Tổng quan', '/app/teacher/dashboard', 'grid'], ['Buổi học', '/app/teacher/sessions', 'calendar'], ['Nội dung', '/app/teacher/content', 'book'], ['Khối lượng công việc', '/app/teacher/workload', 'clock']],
