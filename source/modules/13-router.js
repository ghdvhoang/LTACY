(function defineRouter(root) {
  ...
  const NAV = Object.freeze({
    ...
    TEACHER: [['Tổng quan', '/app/teacher/dashboard', 'grid'], ['Buổi học', '/app/teacher/sessions', 'calendar'], ['Chấm bài', '/app/teacher/grading', 'check'], ['Khối lượng công việc', '/app/teacher/workload', 'clock'], ['Chất lượng', '/app/teacher/quality', 'trend']],
    TA: [['Tổng quan', '/app/teacher/dashboard', 'grid'], ['Buổi học', '/app/teacher/sessions', 'calendar'], ['Khối lượng công việc', '/app/teacher/workload', 'clock']],
    ...
    ADMIN: [['Tổng quan', '/app/admin/dashboard', 'grid'], ['Tài khoản', '/app/admin/access', 'people'], ['Nhật ký', '/app/admin/audit-logs', 'shield'], ['Sự kiện', '/app/admin/events', 'trend'], ['Tích hợp', '/app/admin/integrations', 'grid'], ['Cấu hình', '/app/admin/settings', 'book']],
  });
